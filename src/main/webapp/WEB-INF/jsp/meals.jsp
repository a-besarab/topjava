                            ...
                            <div class="offset-2 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="startDate" class="form-control col-6" id="startDate"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="endDate" class="form-control col-6" id="endDate"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="startTime" class="form-control col-6" id="startTime"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="endTime" class="form-control col-6" id="endTime"
